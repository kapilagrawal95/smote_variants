#SMOTE-tomek documentaion : http://contrib.scikit-learn.org/imbalanced-learn/stable/generated/imblearn.combine.SMOTETomek.html#imblearn.combine.SMOTETomek

#Usage : python3 smotetomek.py <raw-data-csv> <output-csv>
...
d_resampled2,yn_resampled2 = SMOTETomek(k=k,m=m).fit_sample(d,yn)
...
filewrite(open(sys.argv[2],'w'),d_resampled2,yn_resampled2)
