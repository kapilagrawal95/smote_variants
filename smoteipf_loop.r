...
print("start knn : ")
start=as.integer(readLines("stdin",n=1))
print("end knn : ")
end=as.integer(readLines("stdin",n=1))
...
for (k_knn in seq(from=start, to=end, by=2))
{
...
fwrite(D,paste("k",as.character(k_knn),"SMOTEIPF.csv",sep="_"))	#write final dataset to another csv
}